...
ASR_MODEL_PATH = "/home/hhc/ASR/Models/Qwen3-ASR-0.6B"
URL_EN = "/home/hhc/ASR/Qwen3-ASR-main/examples/output_16k.wav"
...
def main() -> None:
    ...
    wav, sr = sf.read(URL_EN, dtype="float32", always_2d=False)
    wav, sr = np.asarray(wav, dtype=np.float32), int(sr)
